...
test.describe('layout', () => {
  test('survives the minimum window size without horizontal scroll', async ({ page }) => {
  ...
  test('collapses to a single pane when narrow', async ({ page }) => {
    ...
    const panes = page.locator('[data-testid="pane-formatted"], [data-testid="pane-markdown"]');
